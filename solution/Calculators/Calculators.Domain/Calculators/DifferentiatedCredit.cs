...
{
    [Calculator("Кредитные калькуляторы", "Калькулятор дифференциального кредита", "DifferentiatedCredit")]
    public class DifferentiatedCredit : Calculator
    {
        ...
        public override CalculateResult Calculate()
        {
            ...
            double mainDebt = Amount / (double)PeriodCount;
